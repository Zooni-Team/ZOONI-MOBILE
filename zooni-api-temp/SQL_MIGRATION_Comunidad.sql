-- ============================================================
-- Migración: Módulo Comunidad (Carteles, Servicios, Amistades, Ubicaciones)
-- Ejecutar contra la base de datos Zooni
-- ============================================================
...
BEGIN
    CREATE TABLE [dbo].[Servicio] (
        ...
        [Tipo]          NVARCHAR(30)  NOT NULL,   -- veterinaria | paseador | petshop | peluqueria
    ...
    -- Índice para búsquedas por bounding box
...
BEGIN
    CREATE TABLE [dbo].[Cartel] (
        ...
        [Id_Mascota]        INT           NULL,
        [Tipo]              NVARCHAR(20)  NOT NULL,   -- perdida | encontrada | adopcion | aviso_general
        [Descripcion]       NVARCHAR(500) NULL,
    ...
    CREATE INDEX [IX_Cartel_Lat_Lng] ON [dbo].[Cartel] ([Lat], [Lng]) WHERE [Activo] = 1;
...
BEGIN
    CREATE TABLE [dbo].[Amistad] (
        ...
        [Estado]         NVARCHAR(15) NOT NULL DEFAULT 'pendiente',  -- pendiente | aceptada | rechazada
        [CreatedAt]      DATETIME2    NOT NULL DEFAULT SYSUTCDATETIME(),
...
BEGIN
    ...
    CREATE INDEX [IX_UbicacionUsuario_Lat_Lng] ON [dbo].[UbicacionUsuario] ([Lat], [Lng])
        WHERE [CompartirUbicacion] = 1;
END
GO
