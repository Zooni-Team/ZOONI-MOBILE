 ...
 *
 * NOTA DE SEGURIDAD: lo ideal es que la key viva como secret de una Edge
 * Function y nunca toque el cliente. Hoy ese backend (supabase/functions/
 * zoonivet-chat) NO está desplegado, así que —por pedido explícito— la llamada
 * se hace desde el cliente con la key del .env. Cuando la Edge Function esté
 * desplegada (supabase functions deploy zoonivet-chat + secrets set), mover la
